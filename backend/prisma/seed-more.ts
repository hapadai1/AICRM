...
function measurementRows(v: {
  ...
  return [
    ['NECK', 'UPPER', v.neck, null, 'CM', 10],
    ['SHOULDER', 'UPPER', v.shoulder, null, 'CM', 20],
    ['CHEST', 'UPPER', v.chest, null, 'CM', 30],
    ['SLEEVE', 'UPPER', v.sleeve, null, 'CM', 40],
    ['BODY_LENGTH', 'UPPER', v.bodyLength, null, 'CM', 50],
    ['WRIST', 'UPPER', v.wrist, null, 'CM', 60],
    ['UPPER_SIZE', 'UPPER', null, v.upperSize, 'SIZE', 70],
    ['WAIST', 'LOWER', v.waist, null, 'CM', 110],
    ['HIP', 'LOWER', v.hip, null, 'CM', 120],
    ['RISE', 'LOWER', v.rise, null, 'CM', 130],
    ['PANTS_LENGTH', 'LOWER', v.pantsLength, null, 'CM', 140],
    ['THIGH', 'LOWER', v.thigh, null, 'CM', 150],
    ['CALF', 'LOWER', v.calf, null, 'CM', 160],
    ['LOWER_SIZE', 'LOWER', null, v.lowerSize, 'SIZE', 170],
    ['SHOE_SIZE', 'SHOES', v.shoeSize, null, 'MM', 210],
  ];
}
