...
export class RentalInventoryController {
  constructor(
    private readonly service: RentalInventoryService,
    private readonly queryService: RentalInventoryQueryService,
  ) {}
  ...
  availability(@Query() query: AvailabilityQueryDto) {
    return this.queryService.availability(query);
  }
  ...
  availabilityCalendar(@Query() query: AvailabilityCalendarQueryDto) {
    return this.queryService.availabilityCalendar(query);
  }
  ...
  summary(@Query() query: InventoryListQueryDto) {
    return this.queryService.summary(query);
  }
  ...
  skuSummary(@Query() query: InventoryListQueryDto) {
    return this.queryService.skuSummary(query);
  }
