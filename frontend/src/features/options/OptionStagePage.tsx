...
import { Alert, Button, Card, Grid, Input, Modal, Progress, Space, Spin, Typography, message } from 'antd';
...
import { fabricFieldLabel, fabricFieldPlaceholder } from './option-meta';
