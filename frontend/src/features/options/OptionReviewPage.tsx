...
import { Alert, Button, Card, Col, Modal, Row, Space, Spin, Tag, Tooltip, Typography, message } from 'antd';
  ...
  if (sessionQuery.isSuccess && !session) {
    return (
      <Alert
        type="info"
        showIcon
        message="아직 옵션 선택을 시작하지 않은 품목입니다."
        action={
      ...
      <Card>
        ...
        {isConfirmed && (
          <Alert
            ...
            type="success"
            showIcon
            message="확정된 옵션입니다. 카드를 눌러 재선택하면 작업지시서 재출력 필요 대상이 됩니다."
          />
        )}
      </Card>
